...
int main () {
	...
	return 0;
	// Voting table is generated completely randomly.
	// When voting table n = 10000 (delta = 1,2,3,4,5 all recorded), the prediction 
	// gives score 0.131309 (for the training set), which is roughly the same as using
	// using training data for the test set (the score kaggle gives for that case is 0.12988). 
	// So we can safely assume that the training sets do generated quite nicely from random 
	// set + five stabilization steps.
	//
	// improvements depent on random set size:
	// since INT_MAX/400 = 214748364/(20*20) = 536870, the max possible run loop is 500000
	// but 200000 => count_case_0[0][0] = 12501665
	// so it should be save to run training loops until 200000*214748364/12501665 = 3435516
	//
	// 10000 0.131309 (623729 12335)
	// 50000 0.128043
	// 100000 0.126965
	// 200000 0.126138
	// 500000 0.125146
